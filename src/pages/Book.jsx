  ...
  return (
    <p
      ...
      className={`border-l-2 py-2 pl-4 text-sm ${
        tone === 'error' ? 'border-[#B4543A] text-[#8A3D28]' : 'border-ink/25 text-slate'
      }`}
    >
      {children}
    </p>
      ...
      <section className="shell pb-section">
        <div className="grid gap-14 lg:grid-cols-12">
          <div className="lg:col-span-7">
            {/* ---------- 1. dates ---------- */}
            {step === 1 && (
              <form onSubmit={goToRooms} className="border border-ink/10 bg-chalk p-8 lg:p-10">
                    ...
                    return (
                      <button
                        ...
                        className={`flex flex-wrap items-baseline justify-between gap-x-6 gap-y-2 border-t border-ink/10 py-5 text-left transition-colors duration-400 ${
                          soldOut ? 'cursor-not-allowed opacity-40' : 'hover:bg-ink/[0.03]'
                        }`}
            ...
            {/* ---------- 3. details ---------- */}
            {step === 3 && (
              <form onSubmit={submit} className="border border-ink/10 bg-chalk p-8 lg:p-10">
